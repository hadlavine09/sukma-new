    ...
    <header class="app-header">
        {{-- <a  href="{{ route('dashboard')}}">Sukma</a> --}}
        <a class="app-header__logo">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="60" height="54"
                viewBox="0 0 200 108">
        ...
        <!-- Sidebar toggle button--><a class="app-sidebar__toggle" href="{{ route('dashboard') }}"
            data-toggle="sidebar" aria-label="Hide Sidebar"></a>
        <!-- Navbar Right Menu-->
        <ul class="app-nav">
            <!--Notification Menu-->
            <li class="dropdown"><a class="app-nav__item" href="{{ route('dashboard') }}" data-bs-toggle="dropdown"
                    aria-label="Show notifications"><i class="bi bi-bell fs-5"></i></a>
                <ul class="app-notification dropdown-menu dropdown-menu-right">
                    <li class="app-notification__title">You have 4 new notifications.</li>
                    <div class="app-notification__content">
                        <li><a class="app-notification__item" href="{{ asset('assets_backend/javascript:;') }}"><span
                    ...
                    <li class="app-notification__footer"><a href="{{ route('dashboard') }}">See all notifications.</a>
                    </li>
                </ul>
            </li>
            <!-- User Menu-->
