...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="bi bi-ui-checks"></i> Tambah Hak Akses</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item"><i class="bi bi-house-door fs-6"></i></li>
            <li class="breadcrumb-item">Forms</li>
            <li class="breadcrumb-item active"><a href="#">Tambah Hak Akses</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" name="hakakses" required>
                                    ...
                                    <option value="Create" {{ $hakakses_selected->contains('hakakses', 'Create') ? 'disabled' : '' }}>Create</option>
                                    <option value="Read" {{ $hakakses_selected->contains('hakakses', 'Read') ? 'disabled' : '' }}>Read</option>
                                    <option value="Update" {{ $hakakses_selected->contains('hakakses', 'Update') ? 'disabled' : '' }}>Update</option>
                                    <option value="Delete" {{ $hakakses_selected->contains('hakakses', 'Delete') ? 'disabled' : '' }}>Delete</option>
                                </select>
                            </div>
