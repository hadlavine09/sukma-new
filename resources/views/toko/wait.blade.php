            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <div class="card border-0 shadow-sm p-4">
                        ...
                        <h2 class="mb-3 text-success fw-bold">Terima Kasih!</h2>
                        <p class="fs-5 text-muted">Data toko Anda telah berhasil dikirim.</p>
                        <p class="text-muted">Silakan tunggu proses verifikasi oleh admin. Kami akan mengirimkan
                            notifikasi setelah proses selesai.</p>
                    </div>
                </div>
            </div>
        </div>
