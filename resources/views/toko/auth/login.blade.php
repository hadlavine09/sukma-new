        ...
        <div class="container">
            <div class="row justify-content-center align-items-center g-5">
                ...
                <div class="col-lg-6">
                    ...
                    <p class="text-muted">Kelola toko Anda, pantau pesanan, dan tingkatkan penjualan Anda dengan mudah
                        melalui dashboard penjual kami.</p>
                ...
                <div class="col-lg-5">
                    <div class="card p-4">
                        ...
                        <form method="POST" action="{{ route('logintoko.post') }}">
                            ...
                            <div class="text-center mt-3">
                                <span>Belum punya akun?</span> <a href="{{ route('registertoko') }}"
                                    class="text-green fw-semibold">Daftar sebagai penjual</a>
                            </div>
                        </form>
                    </div>
                </div>
