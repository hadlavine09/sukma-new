...
<head>
    ...
    <title>Pendaftaran Toko Berhasil - Menunggu Verifikasi Admin</title>
...
<body>
   ...
   <section class="py-5 overflow-hidden" style="margin-top: 80px; background-color: #ffffff;">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <div class="card border-0 shadow-sm p-5">
                    ...
                    <!-- Judul utama -->
                    <h2 class="mb-3 fw-bold" style="font-size: 2.5rem; color: #dc3545;">
                        Verifikasi Ditolak
                    </h2>

                  <!-- Pesan tambahan -->
                    <p class="fs-5 text-dark">
                        Maaf, data toko Anda <strong>tidak disetujui</strong> oleh admin.
                    </p>
                    <p class="text-muted">
                        Silakan periksa kembali informasi toko Anda atau hubungi admin untuk keterangan lebih lanjut.
                    </p>

                    <!-- Menampilkan catatan penolakan -->
                    @if (!empty($toko->catatan_penolakan))
                        <div class="alert alert-danger mt-4 text-start">
                            <h5 class="fw-bold">Catatan Penolakan:</h5>
                            <p class="mb-0">{{ $toko->catatan_penolakan }}</p>
                        </div>
                    @endif


                    <!-- Tombol aksi -->
                    <a href="{{ route('verifikasitoko') }}" class="btn btn-warning btn-lg mt-4">
                        Ubah Data & Ajukan Ulang
                    </a>
                </div>
            </div>
        </div>
