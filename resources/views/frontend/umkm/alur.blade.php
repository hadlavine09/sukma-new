...
<body class="img js-fullheight js-fullwidht" width="50%">
    ...
    <div class="card">
        ...
        <div id="kt_app_content_container " class="app-container container-sm">
            ...
            <div class="card-body ">
                ...
                <h2 class="alur">Alur Pendaftaran</h2>
                <hr style="color: green ">
                <div class="timeline shadow">

                    <div class="card mb-3 shadow-dark" style="max-width: 800px;">
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('umkm.alur') }}">daftar</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="{{ asset('assets_frontend/umkm_register/img/ktp.png') }}"
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    <b>
                                        <h5 class="card-title">1.Siapkan data diri</h5>
                                    </b>
                                    <p class="card-text">Siapkan KTP anda untuk mengisi form pendaftaran</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="{{ asset('assets_frontend/umkm_register/img/form.png') }}"
                                    class="img-fluid rounded-start" alt="...">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <b>
                                        <h5 class="card-title">2.Mengisi form di aplikasi</h5>
                                    </b>
                                    <p class="card-text">Saat masuk pada halaman form maka anda akan diminta
                                        untuk
                                        mengisi data sesuai yang ada pada kartu tanda penduduk yang anda punya.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="{{ asset('assets_frontend/umkm_register/img/verifikasi.png') }}"
                                    class="img-fluid rounded-start" alt="...">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <b>
                                        <h5 class="card-title">3.Dapatkan tiket antrean</h5>
                                    </b>
                                    <p class="card-text">setelah anda mendaftar anda akan mendapatkan format
                                        tiket
                                        antrian dalam bentuk pdf atau jpg
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('umkm.register') }}"><button class="btn btn-success me-md-2"
                                    type="button">Mulai mendaftar</button></a>
                        </div>
                    </div>
    ...
    <script src="{{ asset('assets_frontend/umkm_register/js/custom/utilities/modals/create-account.js') }}"></script>
    ...
    <script src="{{ asset('assets_frontend/umkm_register/js/custom/apps/chat/chat.js') }}"></script>
    ...
    <script src="{{ asset('assets_frontend/umkm_register/js/custom/utilities/modals/users-search.js') }}"></script>
