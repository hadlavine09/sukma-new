                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input class="form-control" type="text"
                                                                name="nama_toko" placeholder="Masukan Nama Toko"
                                                                id="nama_toko" maxlength="100" required>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <select id='tujuan' class="form-control custom-select"
                                                                name='tujuan'>
                                                                <option value=''>-- Masukan Kantor Tujuan --
                                                                </option>
                                    ...
                                    <div class="form active" id="form-confirm">
                                        ...
                                        <div class="container py-5 px-md-5 ">
                                            <fieldset>
                                                ...
                                                <div class="row mb-3">
                                                    <label for="conf-kanotr-tujuan"
                                                        class="col-sm-4 col-form-label form-label">Alamat
                                                        Kantor</label>
                                                    <div class="col-sm-8">
                                                ...
                                                <div class="row mb-3">
                                                    <label for="conf-alamat"
                                                        class="col-sm-4 col-form-label form-label">Jenis
                                                        Layanan</label>
                                                    <div class="col-sm-8">
                                                ...
                                                <div class="row mb-3">
                                                    <label for="conf-sesi-pelayanan"
                                                        class="col-sm-4 col-form-label form-label">Sesi
                                                        Kunjungan</label>
                                                    <div class="col-sm-8">
                                                        <input class="form-control" type="text"
                                            ...
                                            <div class="row mb-3">
                                                <div class="h-captcha"
                                                    data-sitekey="75992a63-43e1-4304-9c19-f90961c7f26b"><iframe
                                                        ...
                                                        data-hcaptcha-widget-id="0eye8fgutumg"
                                ...
                                <div data-kt-stepper-element="content">
                                    ...
                                    <div class="form active">
                                        ...
                                        <div class="container bg-white shadow col-lg-10 row mx-auto tiket p-3">
                                            <div
                                                class="container col-md-8 d-flex flex-column justify-content-around row">
                                                {{-- @php $no= 1; @endphp --}}
                                        ...
                                        <div class="container p-3">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-8 row align-items-center m-auto">
                                                        <input class="form-control col" type="text"
                                                            id="layanan_akhir" value="" disabled>
                                                    </div>
                                                </div>
                                                <div class="input-group">
                                                    <label for="input-tiket"
                                            ...
                                            <small class="text-danger">
                                                <b>Catatan</b> : Pengubahan jenis layanan dan waktu pelayanan hanya
                                                dapat
