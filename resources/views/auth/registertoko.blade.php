        ...
        <div class="container">
            <div class="row justify-content-center align-items-center g-5">
                ...
                <div class="col-lg-6">
                    ...
                    <p class="text-muted">Jual produkmu dengan mudah, kelola pesanan, dan kembangkan bisnismu bersama
                        SukMa Marketplace.</p>
                    <ul class="list-unstyled mt-4">
                        ...
                        <li class="d-flex">
                            ...
                            <div>
                                ...
                                <small class="text-muted">Gunakan fitur promosi untuk memperluas jangkauan
                                    pasar.</small>
                            </div>
                        </li>
                    </ul>
                        ...
                        <form method="POST" action="{{ route('register.toko') }}">
                            ...
                            <div class="text-center mt-4">
                                ...
                                <div class="d-flex justify-content-center align-items-center gap-2 mt-2">
                                    ...
                                    <a href="{{ route('register2') }}" class="text-success fw-semibold">Daftar sebagai
                                        Pengguna</a>
                                </div>
                            </div>
