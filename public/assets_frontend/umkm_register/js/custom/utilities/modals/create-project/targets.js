    ...
    return {
        init: function () {
            (r = KTModalCreateProject.getForm()),
                ...
                new Tagify(r.querySelector('[name="target_tags"]'), { whitelist: ["Important", "Urgent", "High", "Medium", "Low"], maxTags: 5, dropdown: { maxItems: 10, enabled: 0, closeOnSelect: !1 } }).on("change", function () {
