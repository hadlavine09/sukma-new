    ...
    var t,
        ...
        e = function (a) {
            [].slice.call(t.querySelectorAll("[data-kt-plan-price-month]")).map(function (t) {
                ...
                "month" === a ? (t.innerHTML = n) : "annual" === a && (t.innerHTML = e);
            });
        };
    return {
        init: function () {
            (t = document.querySelector("#kt_modal_upgrade_plan")) &&
                ...
                a.addEventListener("click", function (t) {
                    t.preventDefault(), a.classList.add("active"), n.classList.remove("active"), e("month");
                }),
                n.addEventListener("click", function (t) {
                    t.preventDefault(), a.classList.remove("active"), n.classList.add("active"), e("annual");
                }),
                e());
        },
    };
